...
export default function AthleteApp() {
  ...
  const fetchAll = useCallback(async () => {
    ...
    try {
      ...
      const [recordsRes,injuriesRes,perfHistRes,sessionsRes,compsRes,coachRes,allAthletesRes,myPerfsRes,goalsRes,notifsRes] = await Promise.all([
