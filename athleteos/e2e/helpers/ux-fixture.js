...
export async function installUxFixture(page, { role = "head_coach", empty = false, configured = true, keys = ["planning", "performances", "messaging"] } = {}) {
  const writes = [];
  ...
  const athletes = empty ? [] : [
    { id: 10, name: "Alice Martin", user_id: 2, club_id: 1, group_name: "Sprint", main_discipline: "100m", profile_data: {}, records: {} },
    { id: 11, name: "Léa Simon", user_id: 3, club_id: 1, group_name: "Sprint", main_discipline: "100m", profile_data: {}, records: {} },
  ];
